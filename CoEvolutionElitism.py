...
# Constants
# -------------------------
POPULATION_SIZE = 20    # Default popuulation is 20, modified is 40
GENERATIONS = 50    # Default generations is 50, modified is 100
NUM_MATINGS = 10
GAME_ROUNDS = 151
MUTATION_RATE = 0.01
CHROMOSOME_LENGTH = 70
NUM_RUNS = 30
ELITISM_COUNT = 2  # Number of best individuals to preserve each generation, default is 2, modified is 4
...
def run_coevolutionary_ga(seed=None):
    ...
    for generation in range(GENERATIONS):
        ...
        # ELITISM: Select top individuals to preserve
        elite_indices = np.argsort(scores)[-ELITISM_COUNT:]  # Get indices of top ELITISM_COUNT
        ...
        # Adjust number of matings to account for elites
        num_children_needed = POPULATION_SIZE - ELITISM_COUNT
        new_population = elites.copy()  # Start with elite individuals
        
        children_created = 0
        while children_created < num_children_needed:
            ...
            if children_created < num_children_needed:
...
# -------------------------
def save_results(all_results, overall_best_chromosome, overall_best_population, filename_prefix="CoEvolution_Elitism_Results"):
    """
    ...
    json_data = {
        'metadata': {
            ...
            'mode': 'CO-EVOLUTION with ELITISM'
        },
        'aggregated_scores': {
    ...
    with open(text_filename, 'w') as f:
        ...
        f.write(f"Elitism count: {ELITISM_COUNT}\n")
        f.write(f"Mode: CO-EVOLUTION with ELITISM (population plays against itself)\n\n")
...
def run_multiple_experiments():
    ...
    print("Axelrod Co-evolutionary Genetic Algorithm with Elitism")
    print("=" * 60)
    ...
    print("Mode: CO-EVOLUTION with ELITISM (population plays against itself)")
    print("=" * 60)
